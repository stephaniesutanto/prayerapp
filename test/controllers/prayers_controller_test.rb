...
class PrayersControllerTest < ActionController::TestCase
  ...
  test "should create prayer" do
    assert_difference('Prayer.count') do
      post :create, prayer: { category: @prayer.category, description: @prayer.description, name: @prayer.name, pray: @prayer.pray, status: @prayer.status }
    end
  ...
  test "should update prayer" do
    patch :update, id: @prayer, prayer: { category: @prayer.category, description: @prayer.description, name: @prayer.name, pray: @prayer.pray, status: @prayer.status }
    assert_redirected_to prayer_path(assigns(:prayer))
  end
